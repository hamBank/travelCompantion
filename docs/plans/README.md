...
| [plan-13-passport-ocr.md](plan-13-passport-ocr.md) | Passport MRZ OCR with per-field selectable review | M | plan-12a, plan-12c (reads/writes the Documents section) |
